...
const ApplicationList = () => {
  ...
  const fetchApplications = async () => {
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_BACKEND_URL}/leaves`, {
        method: "GET",
        credentials: "include",
      });
  ...
  const updateStatus = async (id, status) => {
    try {
      const res = await fetch(`${import.meta.env.VITE_BACKEND_URL}/leaves/${id}/status`, {
        method: "PUT",
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_BACKEND_URL}/leaves/${id}`, {
        method: "DELETE",
        credentials: "include",
      });
