...
const DepartmentList = () => {
  ...
  const fetchDepartments = async () => {
    try {
      const res = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/departments`, { withCredentials: true });
  ...
  const handleEditSave = async (updatedDept) => {
    try {
      const res = await axios.put(
        `${import.meta.env.VITE_BACKEND_URL}/departments/${updatedDept._id}`,
  ...
  const handleDelete = async (id, name) => {
    if (!isAdmin) return;
    try {
      await axios.delete(`${import.meta.env.VITE_BACKEND_URL}/departments/${id}`, { withCredentials: true });
